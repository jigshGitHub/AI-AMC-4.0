...
def chat():
    ...
    try:
        ...
        # result is expected to be a dict with salary_analysis and retrieved_sources
        return jsonify({"success": True, "answer": result.get("salary_analysis", ""), "sources": result.get("retrieved_sources", "")})
